function opt = cvx_tnn(A0, B, K1, K2, gamma, par)
%#ok<*EQEFF>
%#ok<*STOUT>
%#ok<*VUNUS>
...
switch par.m.opt_mode
    
    case 'penalize_D'
        
        minimize(norm_nuc(Z) - trace(K1*Z*K2') + gamma*norm(vec(D),1))
        
    case 'optimize_W'
        
        minimize(norm_nuc(Z) - trace(K1*Z*K2') - gamma*delta)
